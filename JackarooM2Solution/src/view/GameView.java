...
public class GameView {
    ...
    private Map<Cell, StackPane> cellViews;
    ...
    private Spinner<Integer> splitDistanceSpinner;
    ...
    private void setupPlayerInfoSection() {
        ...
        playerInfoBox.getChildren().addAll(currentPlayerLabel, turnInfoLabel);
    }
    ...
    private VBox setupControlArea() {
        ...
        splitDistanceSpinner = new Spinner<>(1, 6, 3);
        splitDistanceSpinner.setEditable(true);
        splitControl.getChildren().addAll(splitLabel, splitDistanceSpinner);
    ...
    public Spinner<Integer> getSplitDistanceSpinner() {
        return splitDistanceSpinner;
    }
    ...
    public class CardView extends StackPane {
        ...
        public CardView(Card card) {
            ...
            content.getChildren().addAll(nameLabel, descriptionLabel);
